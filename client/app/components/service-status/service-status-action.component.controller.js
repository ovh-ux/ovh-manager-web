import {
  DEFAULT_TARGET,
  RENEW_URL,
} from './service-status-action.component.constant';

(() => {
  class ServiceStatusActionComponentCtrl {
    constructor($scope, $rootScope, constants, OvhApiMe) {
    ...
    isExpired() {
      ...
      return (
        this.serviceInfos.expiration && diff <= 0
      );
    }
  }

  angular.module('directives').controller('serviceStatusActionComponentCtrl', ServiceStatusActionComponentCtrl);
})();

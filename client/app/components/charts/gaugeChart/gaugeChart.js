const thegauge = [];
angular.module("directives").directive("gaugeChart", [
    "$timeout",
    function ($timeout) {
        "use strict";
        return {
                ...
                function printGauge () {
                    ...
                    if (nv != null && ($scope.max !== undefined && $scope.max !== null)) {
                        ...
                        if ($scope.gauge === undefined) {
                            ...
                            $scope.gauge.txtMax.attr("text", `${$scope.gauge.txtMax.attrs.text} ${$scope.diskUnit}`);
                            $scope.gauge.txtMin.attr("text", `${$scope.gauge.txtMin.attrs.text} ${$scope.diskUnit}`);
                        } else {

        ...
        $onInit () {
            ...
            this.$scope.loadOwoFields = () => {
                this.DomainsOwo.getOwoFields()
                    ...
                    .catch((err) => {
                        this.Alerter.alertFromSWS(this.$scope.tr("domains_configuration_whois_fail"), err, this.$scope.alerts.content);
            ...
            this.$scope.updateOwo = () => {
                ...
                this.DomainsOwo
                    ...
                    .then((data) => this.Alerter.alertFromSWSBatchResult(this.domainsOwoMessages, data, this.$scope.alerts.content))
                    .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("domains_configuration_whois_fail"), err, this.$scope.alerts.content));
            };
        }

    ...
    class DomainsDnssecSimpleActivateCtrl {
        ...
        $onInit () {
            ...
            this.$scope.updateDnssec = () => {
                ...
                this.DomainsDnsSec
                    .updateDnssecState(true, [this.selectedDomain.name])
                    .then((data) =>
                    ...
                    .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("domains_configuration_dnssec_simple_activate_fail"), err, this.$scope.alerts.dashboard));
            };
        }
    }
);

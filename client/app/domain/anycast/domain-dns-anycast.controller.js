    ...
    class DomainDnsAnycastActivateCtrl {
        ...
        loadOptionDetails () {
            ...
            return this.Domain
                ...
                .catch((err) => {
                    this.Alerter.alertFromSWS(this.$scope.tr("domain_configuration_dnsanycast_fail"), _.get(err, "data", err), this.$scope.alerts.page);
        ...
        displayBC () {
            this.$scope.resetAction();
            this.Alerter.success(this.$scope.tr("domain_order_dns_anycast_success", [this.url]), this.$scope.alerts.page);

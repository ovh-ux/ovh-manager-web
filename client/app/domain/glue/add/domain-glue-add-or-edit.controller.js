angular.module("controllers").controller(
    ...
    class DomainGlueAddOrEditCtrl {
        ...
        addOrEditGlueRecord () {
            ...
            return promise
                .then(() => this.Alerter.success(this.$scope.tr(this.editMode ? "domain_tab_GLUE_modify_success" : "domain_tab_GLUE_add_success"), this.$scope.alerts.domainGlue))
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr(this.editMode ? "domain_tab_GLUE_modify_error" : "domain_tab_GLUE_add_error"), err, this.$scope.alerts.domainGlue))
                .finally(() => {
                    this.loading = false;

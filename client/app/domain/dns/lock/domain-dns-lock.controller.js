    ...
    class DomainDnsLockCtrl {
        ...
        updateDomainLock () {
            ...
            return this.Domain
                ...
                .then(() => this.Alerter.success(this.$scope.i18n.domain_tab_DNS_lock_success, this.$scope.alerts.domainDns))
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.i18n.domain_tab_DNS_lock_error, err, this.$scope.alerts.domainDns))
                .finally(() => {

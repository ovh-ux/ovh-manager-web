angular.module("controllers").controller(
    ...
    class RedirectionEdit {
        ...
        isTargetValid () {
            ...
            return !_.isEmpty(this.redirectionTarget) && this.constructor.isLengthValid(completeTarget);
        }
        ...
        getNonOrtLabel () {
            ...
            default: {
                ...
                this.alerter.alertFromSWS(this.$scope.tr("domain_tab_REDIRECTION_edit_fail", this.displayName), errorMessage, this.$scope.alerts.dashboard);
         ...
         */
        getCompleteTarget () {
            let redirectionTarget = this.redirectionTarget;
        ...
        redirectionTargetChange () {
            if (_.isEmpty(this.redirectionTarget)) {
                ...
                this.errors.redirectionTarget = !this.validator.isURLValid(this.redirectionTarget);
                this.errors.targetLength = !this.isTargetValid();
            } else {
                switch (this.redirection.fieldDisplayType) {
                case "A":
                    this.errors.redirectionTarget = !this.validator.isIPv4Valid(this.redirectionTarget);
                    break;
                case "AAAA":
                    this.errors.redirectionTarget = !this.validator.isIPv6Valid(this.redirectionTarget);
                    break;
                case "CNAME": {
        ...
        isTargetLengthValid () {
            ...
            const shouldAppendZone = this.shouldIncludeDomain && _.isString(this.redirection.fieldDisplayType) && this.redirection.fieldDisplayType.toUpperCase() === "CNAME";
        ...
        editRedirection () {
            ...
            if (this.redirection.isOrt) {
                data = _.assign(data, _.pick(this.redirection, ["description", "keywords", "title"]));
                method = "putOrt";
            }

            this.service[method](this.redirection.id, data)
                .then(() => this.alerter.success(this.$scope.tr("domain_tab_REDIRECTION_edit_success", this.displayName), this.$scope.alerts.dashboard))
                .catch((err) => this.alerter.alertFromSWS(this.$scope.tr("domain_tab_REDIRECTION_edit_fail", this.displayName), err, this.$scope.alerts.dashboard))
                .finally(() => {
        ...
        includeDomainToTarget () {
            ...
            const targetIsCNAME = _.isString(this.redirection.fieldDisplayType) && this.redirection.fieldDisplayType.toUpperCase() === "CNAME";
            ...
            if (shouldDeleteTrailingDot) {
                return this.redirectionTarget.substring(0, this.redirectionTarget.length - 1);
            }

angular.module("controllers").controller(
    ...
    class DomainRedirectionDeleteCtrl {
        ...
        deleteRedirection () {
            ...
            return this.$q
                .all(deletePromises)
                .then(() => this.Alerter.success(this.$scope.tr("domain_tab_REDIRECTION_delete_success"), this.$scope.alerts.domainRedirection))
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("domain_tab_REDIRECTION_delete_fail"), err, this.$scope.alerts.domainRedirection))
                .finally(() => {
                    this.loading = false;

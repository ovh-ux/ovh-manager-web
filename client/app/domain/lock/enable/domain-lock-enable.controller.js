        ...
        lockDomain () {
            return this.Domain
                ...
                .then((data) => {
                    ...
                    this.Alerter.success(this.$scope.tr("domain_configuration_protection_activate_success"), this.$scope.alerts.domainState);
                })
                .catch((err) => {
                    this.$rootScope.$broadcast("domain.protection.lock.error", err);
                    this.Alerter.alertFromSWS(this.$scope.tr("domain_configuration_protection_activate_fail"), _.get(err, "data", err), this.$scope.alerts.domainState);
                })
                .finally(() => {
                    this.$scope.resetAction();
                });

angular.module("App").controller(
    ...
    class DomainDynHostLoginEditCtrl {
        ...
        updateLogin () {
            ...
            return this.$q
                .all(promises)
                .then(() => this.Domain.refreshZoneState(this.product.name).then(() => this.Alerter.success(this.$scope.tr("domain_tab_DYNHOSTLOGIN_edit_success"), this.$scope.alerts.domainDynhost)))

angular.module("App").controller(
    ...
    class DomainDynHostLoginEditCtrl {
        ...
        subDomainCheck (input) {
            input.$setValidity("subdomain", this.login.subDomain === null || this.login.subDomain === "" || this.login.subDomain === "*" || this.Validator.domain.isValid(this.login.subDomain, { isSubDomain: true }));
        }

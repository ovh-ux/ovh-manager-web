    ...
    class DomainDynHostLoginDeleteCtrl {
        ...
        deleteLogin () {
            ...
            return this.Domain
                ...
                .then(() => this.Domain.refreshZoneState(this.zoneName).then(() => this.Alerter.success(this.$scope.tr("domain_tab_DYNHOSTLOGIN_delete_success"), this.$scope.alerts.domainDynhost)))

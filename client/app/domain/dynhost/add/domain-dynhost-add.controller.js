    ...
    class DomainDynHostAddCtrl {
        ...
        addDynHost () {
            ...
            return this.Domain
                ...
                .then(() => this.Domain.refreshZoneState(this.product.name).then(() => this.Alerter.success(this.$scope.tr("domain_tab_DYNHOST_add_success"), this.$scope.alerts.dashboard)))

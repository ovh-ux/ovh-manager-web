angular.module("App").controller(
    ...
    class DomainDynHostAddCtrl {
        ...
        addDynHost () {
            this.loading = true;
            return this.Domain
                .addDynHost(this.product.name, {
                    ip: this.dynHost.ipTarget,
                    subDomain: punycode.toASCII(this.dynHost.subDomain)
                })
                .then(() => this.Domain.refreshZoneState(this.product.name).then(() => this.Alerter.success(this.$scope.tr("domain_tab_DYNHOST_add_success"), this.$scope.alerts.domainDynhost)))

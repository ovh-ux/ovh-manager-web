angular.module("App").controller(
    ...
    class DomainDynHostAddCtrl {
        ...
        ipTargetCheck (input) {
            input.$setValidity("iptarget", this.Validator.ip.isValid(this.dynHost.ipTarget, { version: 4, cidr: "FORBIDDEN" }));
        }
        ...
        addDynHost () {
            ...
            return this.Domain
                ...
                .then(() => this.Domain.refreshZoneState(this.product.name).then(() => this.Alerter.success(this.$scope.tr("domain_tab_DYNHOST_add_success"), this.$scope.alerts.main)))

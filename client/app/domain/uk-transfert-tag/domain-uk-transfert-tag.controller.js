    ...
    class DomainUkTransfertTagCtrl {
        ...
        addTagUkTransfer () {
            ...
            return this.Domain
                ...
                .then(() => this.Alerter.success(this.$scope.tr("domain_dashboard_add_uk_tags_success"), this.$scope.alerts.domainState))
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("domain_dashboard_add_uk_tags_error"), err, this.$scope.alerts.domainState))
                .finally(() => {
                    this.loading = false;

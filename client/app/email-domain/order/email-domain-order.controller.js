angular.module("App").controller(
     ...
     */
        ...
        initialLoad () {
            ...
            this.User.getUrlOfEndsWithSubsidiary("MX_PLAN").then((page) => (this.urls.mxPlanProductDescription = page));

            return this.Domain.getDomains().then((domains) => (this.list.domains = domains)).catch(() => this.Alerter.error(this.$scope.tr("mxPlan_order_step1_error"), this.$scope.alerts.order)).finally(() => (this.loading.init = false));
        }

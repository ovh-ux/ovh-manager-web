    ...
    class MailingListsDeleteSubscribersCtrl {
        ...
        deleteSubscribers () {
            ...
            return this.MailingLists
                ...
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr(subscribersToDelete.length === 1 ? "mailing_list_tab_modal_subscriber_delete_error" : "mailing_list_tab_modal_subscribers_delete_error"), err, this.$scope.alerts.dashboard))
                .finally(() => {
                    this.loading = false;

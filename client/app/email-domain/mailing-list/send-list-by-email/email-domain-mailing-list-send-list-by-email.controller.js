    ...
    class MailingListsSendListByEmailCtrl {
        ...
        sendListByEmail () {
            ...
            return this.MailingLists
                ...
                .then((task) => {
                    this.Alerter.success(this.$scope.tr("mailing_list_tab_modal_sendListByEmail_success", this.email), this.$scope.alerts.emailDomainMailingListView);
                ...
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("mailing_list_tab_modal_sendListByEmail_error"), _.get(err, "data", err), this.$scope.alerts.emailDomainMailingListView))
                .finally(() => {
                    this.loading = false;

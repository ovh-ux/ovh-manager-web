    ...
    class MailingListsCreateCtrl {
        ...
        createMailingList () {
            return this.MailingLists
                ...
                .then(() => this.Alerter.success(this.$scope.tr("mailing_list_tab_modal_create_list_success"), this.$scope.alerts.emailDomainMailingListView))
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("mailing_list_tab_modal_create_list_error"), err, this.$scope.alerts.emailDomainMailingListView))

    ...
    class MailingListsDeleteModeratorCtrl {
        ...
        deleteModerators () {
            ...
            return this.MailingLists
                ...
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr(this.moderators.length === 1 ? "mailing_list_tab_modal_moderator_delete_error" : "mailing_list_tab_modal_moderators_delete_error"), err, this.$scope.alerts.dashboard))
                .finally(() => {
                    this.loading = false;

angular.module("App").controller(
    ...
    class EmailsImportFromImapCtrl {
        ...
        importFromImap () {
            ...
            return this.Emails
                .imapCopy(data)
                .then(() => this.Alerter.success(this.$scope.tr("email_tab_modal_import_from_imap_success"), this.$scope.alerts.emailDomainAccounts))
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("email_tab_modal_import_from_imap_error"), _.get(err, "data", err), this.$scope.alerts.emailDomainAccounts))

    ...
    class EmailsUpdateAccountCtrl {
        ...
        getAccountSize () {
            ...
            return accountSizePromise
                ...
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("email_tab_error"), _.get(err, "data", err), this.$scope.alerts.emailDomainAccounts))
        ...
        updateAccount () {
            ...
            return accountPromise
                .then(() => this.Alerter.success(this.$scope.tr("email_tab_modal_update_account_success"), this.$scope.alerts.emailDomainAccounts))
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("email_tab_modal_update_account_error"), _.get(err, "data", err), this.$scope.alerts.emailDomainAccounts))
                .finally(() => {
                    this.loading = false;

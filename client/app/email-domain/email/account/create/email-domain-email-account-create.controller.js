angular.module("App").controller(
    ...
    class EmailsCreateAccountCtrl {
        ...
        accountPasswordCheck (input) {
            input.$setValidity(
                "passwordCheck",
                !!this.account.password && (!/^\s/.test(this.account.password) && !/\s$/.test(this.account.password)) && !this.account.password.match(/[ÂÃÄÀÁÅÆÇÈÉÊËÌÍÎÏÐÑÒÓÔÕÖØÙÚÛÜÝÞßàáâãäåæçèéêëìíîïðñòóôõöøùúûüýþÿ]/)
            );
        }
        ...
        createAccount () {
            ...
            this.Emails
                ...
                .then(() => this.Alerter.success(this.$scope.tr("email_tab_modal_create_account_success"), this.$scope.alerts.emailDomainAccounts))
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("email_tab_modal_create_account_error"), err, this.$scope.alerts.emailDomainAccounts))
        ...
        getAccountSize () {
            ...
            this.$q
                .all({
                    ...
                    emails: this.Emails.getEmails(this.$stateParams.productId, { accountName: "%" })
                })
                ...
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("email_tab_error"), err.data, this.$scope.alerts.emailDomainAccounts))

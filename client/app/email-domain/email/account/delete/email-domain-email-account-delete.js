    ...
    class EmailsDeleteAccountCtrl {
        ...
        deleteAccount () {
            this.Emails
                ...
                .then(() => this.Alerter.success(this.$scope.tr("email_tab_modal_delete_account_success"), this.$scope.alerts.emailDomainAccounts))
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("email_tab_modal_delete_account_error"), err, this.$scope.alerts.emailDomainAccounts))

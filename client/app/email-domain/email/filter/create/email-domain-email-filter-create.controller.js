    ...
    class EmailsCreateFilterCtrl {
        ...
        createFilter () {
            ...
            return filterPromise
                .then(() => {
                    this.Alerter.success(this.$scope.tr("email_tab_modal_create_filter_success"), this.$scope.alerts.dashboard);
                })
                .catch((err) => {
                    this.Alerter.alertFromSWS(this.$scope.tr("email_tab_modal_create_filter_error"), err, this.$scope.alerts.dashboard);
                })
                .finally(() => {
                    this.loading = false;

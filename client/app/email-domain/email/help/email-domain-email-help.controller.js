angular.module("App").controller(
    ...
    class EmailsHelpCtrl {
        ...
        $onInit () {
            ...
            this.quotas = _.get(this.$scope.currentActionData, "quotas", { account: 0, mailingList: 0, redirection: 0, responder: 0 });
            this.responders = [];
            this.summary = _.get(this.$scope.currentActionData, "summary", { account: 0, redirection: 0, responder: 0 });

            this.canCreate = {
                account: this.quotas.account > 0 && this.summary.account - 1 < this.quotas.account,
                mailingList: this.quotas.mailingList > 0,
                redirection: this.summary.redirection < this.quotas.redirection + this.quotas.alias,
                responder: this.quotas.account > 0 && this.summary.responder < this.quotas.responder
            };

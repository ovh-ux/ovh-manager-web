    ...
    class EmailsUpdateRedirectionCtrl {
        ...
        updateRedirection () {
            return this.Emails
                ...
                .then(() => this.Alerter.success(this.$scope.tr("email_tab_modal_update_redirection_success"), this.$scope.alerts.main))
                .catch((err) => this.Alerter.alertFromSWS(this.$scope.tr("email_tab_modal_update_redirection_error"), err, this.$scope.alerts.main))

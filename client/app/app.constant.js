angular.module("App").constant("constants", {
    prodMode: false, // mode === "prod",
    aapiRootPath: "/engine/2api/", // "<%= aapiPath %>",
    renew: "https://eu.ovh.com/fr/cgi-bin/order/renew.cgi?domainChooser={serviceName}",
    loginUrl: "/auth",
    urls: {
        managerv3: {
        ...
        DE: {
            ...
            domainOrder: "https://www.ovh.de/cgi-bin/newOrder/order.cgi",
        ...
        ES: {
            ...
            domainOrder: "https://www.ovh.es/cgi-bin/newOrder/order.cgi",
        ...
        IT: {
            ...
            domainOrder: "https://www.ovh.it/cgi-bin/newOrder/order.cgi",
        ...
        LT: {
            ...
            domainOrder: "https://www.ovh.lt/cgi-bin/newOrder/order.cgi",
        ...
        NL: {
            ...
            dnssec_service: "https://www.ovh.com/fr/domaines/service_dnssec.xml",
            vpsCloud: "https://www.ovh.com/fr/vps/vps-cloud.xml",
            domainOrder: "https://www.ovh.nl/cgi-bin/newOrder/order.cgi",
        ...
        PL: {
            ...
            domainOrder: "https://www.ovh.pl/cgi-bin/newOrder/order.cgi",
        ...
        PT: {
            ...
            domainOrder: "https://www.ovh.pt/cgi-bin/newOrder/order.cgi",
    ...
    urchin: "https://logs.ovh.net/{serviceName}/urchin6/",
    urchin_gra: "https://logs.{cluster}.hosting.ovh.net/{serviceName}/urchin6/",

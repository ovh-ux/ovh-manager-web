angular.module("App").controller(
    ...
    class PrivateDatabaseOrderCtrl {
        ...
        loadPrices (durations) {
            ...
            this.$q
                .all(
                    _.map(durations, (duration) => this.privateDatabaseService.orderPrice(this.selectedOrder.config.version, this.selectedOrder.config.ramSize, duration).then((details) => {

angular.module('App').controller(
  ...
  class PrivateDatabaseArchiveListCtrl {
    ...
    getDump(dumpId) {
      return this.privateDatabase.getDump(this.productId, dumpId)
    ...
    getDumps() {
      ...
      return this.privateDatabase.getDumps(this.productId, true)
        ...
        .then((dumps) => {
          ...
          this.deletedDbList = _.values(deletedDbs).sort((a, b) => a.databaseName.localeCompare(b.databaseName));
        })
        .catch(err => this.alerter.error(err));
    }
  },

        ...
        $onInit () {
            ...
            this.$scope.updateWhitelist = () => {
                this.whitelistService
                    ...
                    .then(() => this.alerter.success(this.$scope.tr("privateDatabase_modale_whitelist_update_success"), "privateDataBase.alerts.whitelist"))
                    .catch(() => this.alerter.error(this.$scope.tr("privateDatabase_modale_whitelist_update_fail"), "privateDataBase.alerts.whitelist"))

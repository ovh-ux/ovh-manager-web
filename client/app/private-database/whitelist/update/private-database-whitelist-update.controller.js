        ...
        $onInit () {
            ...
            this.$scope.updateWhitelist = () => {
                this.whitelistService
                    ...
                    .then(() => this.alerter.success(this.$scope.tr("privateDatabase_modale_whitelist_update_success"), this.$scope.alerts.main))
                    .catch(() => this.alerter.error(this.$scope.tr("privateDatabase_modale_whitelist_update_fail"), this.$scope.alerts.main))
